module Spree
  class PayumoneyController < StoreController
    ...
    def confirm
      ...
      checksum_matched = payment_method.checksum_ok?([params[:status], '', '', '', '', '', '', params[:udf4], params[:udf3], params[:udf2], params[:udf1], params[:email], params[:firstname], params[:productinfo], params[:amount], params[:txnid]], params[:hash])
      if !checksum_matched
